...
public class Log2Test {
    ...
    @CsvFileSource(resources = "/test/logarithms/resources/log2.csv", delimiter = ';')
    public void calculateCsvTest(double x, double y) {
        Double result = y - Log.calculate(x, 2.0);
    ...
    public void calculateCriticalTest(double value) {
        Assertions.assertTrue(Double.isNaN(Log.calculate(value, 2.0)));
    }
