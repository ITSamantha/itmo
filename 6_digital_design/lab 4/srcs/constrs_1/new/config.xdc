...
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports BUSY]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports MODE]
set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports SHOW_COUNT]
